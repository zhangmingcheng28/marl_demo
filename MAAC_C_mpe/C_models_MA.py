...
class ActorIndependent(nn.Module):
    ...
    def _define_parameters(self):
        ...
        for i in range(self.args.agent_count):
            ...
            if self.args.env_name in ["routing6v4", "routing12v20", "routing24v128", "simple_spread"]:
        ...
        for i in range(self.args.agent_count):
            ...
            if self.args.env_name in ["routing6v4", "routing12v20", "routing24v128", "simple_spread"]:
                ...
                if action_dim == 2:  # the flow will go to egress-C !or! egress-D
                    ...
                    action = F.tanh(self.parameters_all_agent[i]["action"](out))  # tanh
                elif action_dim == 4:  # the flow will go to egress-C !and! egress-D
...
class Agent(object):
    def __init__(self, args):
        self.args = args
        self.var = [1.0 for _ in range(args.agent_count)]
